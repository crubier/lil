		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSignalDeclarationAccess().getGroup_4(), "rule__SignalDeclaration__Group_4__0");
					...
					put(grammarAccess.getSignalDeclarationAccess().getNameAssignment_0(), "rule__SignalDeclaration__NameAssignment_0");
					put(grammarAccess.getSignalDeclarationAccess().getTypeAssignment_2(), "rule__SignalDeclaration__TypeAssignment_2");
					put(grammarAccess.getSignalDeclarationAccess().getModeAssignment_3(), "rule__SignalDeclaration__ModeAssignment_3");
					put(grammarAccess.getSignalDeclarationAccess().getSourceAssignment_4_1(), "rule__SignalDeclaration__SourceAssignment_4_1");
					put(grammarAccess.getSignalDeclarationAccess().getDestinationsAssignment_5_1(), "rule__SignalDeclaration__DestinationsAssignment_5_1");
