...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Literal Time</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 *   <li>{@link com.crubier.lil.lil.LiteralTime#getHour <em>Hour</em>}</li>
 *   <li>{@link com.crubier.lil.lil.LiteralTime#getMinute <em>Minute</em>}</li>
 *   <li>{@link com.crubier.lil.lil.LiteralTime#getSecond <em>Second</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.crubier.lil.lil.LilPackage#getLiteralTime()
 * @model
 * @generated
 */
public interface LiteralTime extends Expression
{
   ...
   * @see #setYear(double)
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Year()
   * @model
   * @generated
   */
  double getYear();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getYear <em>Year</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMonth(double)
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Month()
   * @model
   * @generated
   */
  double getMonth();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getMonth <em>Month</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDay(double)
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Day()
   * @model
   * @generated
   */
  double getDay();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getDay <em>Day</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setHour(double)
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Hour()
   * @model
   * @generated
   */
  double getHour();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getHour <em>Hour</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMinute(double)
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Minute()
   * @model
   * @generated
   */
  double getMinute();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getMinute <em>Minute</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.crubier.lil.lil.LilPackage#getLiteralTime_Second()
   * @model
   * @generated
   */
  double getSecond();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralTime#getSecond <em>Second</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
