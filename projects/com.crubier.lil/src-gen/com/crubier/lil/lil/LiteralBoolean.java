 ...
 * <ul>
 *   <li>{@link com.crubier.lil.lil.LiteralBoolean#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.crubier.lil.lil.LilPackage#getLiteralBoolean()
 * @model
 * @generated
 */
public interface LiteralBoolean extends Expression
{
   ...
   * @see com.crubier.lil.lil.LilPackage#getLiteralBoolean_IsTrue()
   * @model
   * @generated
   */
  boolean isIsTrue();
  ...
  /**
   * Sets the value of the '{@link com.crubier.lil.lil.LiteralBoolean#isIsTrue <em>Is True</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
