 ...
 * <ul>
 *   <li>{@link com.crubier.lil.lil.impl.LiteralBooleanImpl#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralBooleanImpl extends ExpressionImpl implements LiteralBoolean
{
  ...
  {
    return LilPackage.Literals.LITERAL_BOOLEAN;
  }
  ...
  public void setIsTrue(boolean newIsTrue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LilPackage.LITERAL_BOOLEAN__IS_TRUE, oldIsTrue, isTrue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LilPackage.LITERAL_BOOLEAN__IS_TRUE:
        return isIsTrue();
    }
