...
public class EffectImpl extends MinimalEObjectImpl.Container implements Effect
{
  ...
  public NotificationChain basicSetValue(XExpression newValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LilPackage.EFFECT__VALUE, oldValue, newValue);
  ...
  public void setValue(XExpression newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LilPackage.EFFECT__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LilPackage.EFFECT__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LilPackage.EFFECT__VALUE, newValue, newValue));
  }
